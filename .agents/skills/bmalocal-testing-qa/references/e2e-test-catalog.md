...
| **E2E-04** | **Contact Management** | 1. Search client by phone/reg<br>2. Create new client record<br>3. Link to vehicle profile | Desktop, Tablet, Mobile | Search failure, duplicate entries | **Implemented** (`tests/e2e/test_contact_management.py`) |
...
# Run specifically on Contact management & vehicle profile linking tests
d:\BMAAutoAccessories\venv\Scripts\python.exe -m pytest tests/e2e/test_contact_management.py -v
