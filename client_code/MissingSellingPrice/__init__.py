from ._anvil_designer import MissingSellingPriceTemplate
from anvil import *
import anvil.server
import anvil.users
...
class MissingSellingPrice(MissingSellingPriceTemplate):
    def __init__(self, **properties):
        ...
        self.repeating_panel_1.items = anvil.server.call("missing_selling_prices")
    ...
    def btn_Search_click(self, **event_args):
        ...
        result = anvil.server.call(
            "missing_selling_prices", search_text)
    ...
    def btn_Export_click(self, **event_args):
        ...
        excel_file = anvil.server.call("export_missing_selling_prices", rows)
